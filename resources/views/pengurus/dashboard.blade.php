...
@section('content')
    ...
    <p><strong>Skor Kesehatan {{ $koperasi->nama_koperasi }} : {{ $pemeriksaan->skor_akhir ?? 'Belum ada pemeriksaan'}}</strong><br>
    Kesehatan koperasi Anda dikategorikan {{ strtolower($pemeriksaan->kategori) ?? 'Belum ada pemeriksaan' }}</p>
    <p>
